...
import Distributor from '../build/SoulDistributor.json'
...
const startTime = 1617704800
const endTime = 1620548800

describe('SoulDistributor', () => {
  ...
  describe('#claim', () => {
    ...
    describe('two account tree', () => {
      ...
      it('cannot allow two claims', async () => {
        ...
        await distributor.claim(0, wallet0.address, 100, proof0, overrides)
        await expect(distributor.claim(0, wallet0.address, 100, proof0, overrides)).to.be.revertedWith(
          'SoulDistributor: Drop already claimed.'
        )
      })
      ...
      it('cannot claim more than once: 0 and then 1', async () => {
        ...
        ).to.be.revertedWith('SoulDistributor: Drop already claimed.')
      })
  ...
  describe('parseBalanceMap', () => {
    ...
    it('check the proofs are as expected', () => {
